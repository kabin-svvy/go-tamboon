# on assignment
it not a good performance but i try to use goroutine many way to call api and the limit is over(too many request) and its hard to write test with go channel
i thing i dont have experience to code with good performance on now
